        ...
        <div class="lab-grid">
            ...
            <div class="lab-card sqli">
                ...
                <div class="button-group">
                    <a href="vulnerable/login_vulnerable.php" class="btn btn-danger">Vulnerable Version</a>
                    <a href="secure/login_safe.php" class="btn btn-success">Safe Version</a>
                </div>
            </div>
            ...
            <div class="lab-card xss">
                ...
                <div class="button-group">
                    <a href="vulnerable/comment_vulnerable.php" class="btn btn-warning">Vulnerable Version</a>
                    <a href="secure/comment_safe.php" class="btn btn-success">Safe Version</a>
                </div>
            </div>
            ...
            <div class="lab-card upload">
                ...
                <div class="button-group">
                    <a href="vulnerable/upload_vulnerable.php" class="btn btn-purple">Vulnerable Version</a>
                    <a href="secure/upload_safe.php" class="btn btn-success">Safe Version</a>
                </div>
            </div>
            ...
            <div class="lab-card bac">
                ...
                <div class="button-group">
                    <a href="vulnerable/profile_vulnerable.php?id=101" class="btn btn-info">Vulnerable Version</a>
                    <a href="secure/profile_safe.php?id=101" class="btn btn-success">Safe Version</a>
                </div>
            </div>
        </div>
